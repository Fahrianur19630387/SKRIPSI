        ...
        <div class="col-sm-12">
           <div class="box box-primary">
            <div class="box-header with-border">
                <h3 class="text-left">Rekapitulasi Pemeliharaan Barang</h3>
            </div>  


            <div class="col-md-12">
                <form method="POST" action='cetak_laporan_rekapitulasi_pemeliharaan.php' target="_blank" class="form-inline">
