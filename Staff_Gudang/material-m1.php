    ...
    <div class="col-sm-12">
      <div class="box box-primary">
        ...
        <div class="box-body">
          <div class="row">
            <div class="col-md-2">
              <a href="index.php?p=tambahmaterial-m1" class=" btn btn-primary"><i class="fa fa-plus"></i> Tambah Data Barang</a><br>						
            </div>

            <div class="col-md-2 pull-right">
              <a target="_blank" href="cetak_material.php?idjenis=<?= $id_jenis;  ?>" class="btn btn-success"><i class="fa fa-print"></i> Cetak Data Barang</a><br>
            </div>
            <br><br>
          </div>                        
