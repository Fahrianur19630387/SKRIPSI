...
$query = mysqli_query($koneksi, "SELECT pengajuan.kode_brg, pengajuan.satuan, unit, nama_brg, jumlah, tgl_pengajuan FROM pengajuan INNER JOIN stokbarang ON pengajuan.kode_brg = stokbarang.kode_brg WHERE tgl_pengajuan BETWEEN '$tanggala' and '$tanggalb' "); 
