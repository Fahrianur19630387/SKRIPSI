...
<body>  
       ...
       <div class="judul">
        ...
        <hr class="garis">
         <H4><b>BUKTI PERMINTAAN PEMELIHARAAN BARANG (BPP)</b></H4>
  ...
  <div class="isi" style="margin: 0 auto;">
   ...
   <table border="1" align="center" style="border-collapse:collapse;" width="100%">
      ...
      <tbody>
        ...
        $query = mysqli_query($koneksi, "SELECT * FROM pemeliharaan  WHERE tgl_pemeliharaan BETWEEN '$tanggala' and '$tanggalb' "); 
        $i   = 1;
        $total = 0;
...

        {
          ...
          <tr>
            ...
            <td style="text-align: center; width=100px; font-size: 12px;"><?php echo $data['no_service']; ?></td>      
            <td style="text-align: center; width=150px; font-size: 12px;"><?php echo date('d/m/Y', strtotime($data['tgl_pemeliharaan']));  ?></td>
            ...
            <td style="text-align: center; width=70px; font-size: 12px;"><?php echo $data['catatan']; ?></td>
       ...
       <tr>
              <th>Total Barang</th>        				
                ...
                <td style="text-align: center; width=60px;"><b><?= $total = $total; ?></b></td>    
