              ...
              <tr>
                ...
                if (mysqli_num_rows($query)) {
                  while($row=mysqli_fetch_assoc($query)):
                   ...
                   <td>        
                    <a target="_blank" href="cetakpesanan.php?&tgl=<?= $row['tgl_permintaan']; ?>&unit=<?= $row['unit']; ?>&unit=<?= $row['unit']; ?>"><span data-placement='top' data-toggle='tooltip' title='Cetak BPP'><button class="btn btn-success"><i class="fa fa-print"> Cetak BPP</i></button></span></a>                  
                  </td>
                </tr>        
