...
<head>
  <title>Laporan Data Masuk Barang</title>
...
<body>  
       ...
       <div class="judul">
        ...
        <H4><b>LAPORAN DATA MASUK BARANG</b></H4>
             <table>
  <tr>
    <td align="left"><b>Jenis Transaksi</b></td>
    <td ><b>:</b></td>
    <td width="600px" align="left"><b>REPORT MASUK BARANG</b></td>
...
<tr>
    ...
    <table border="1" align="center" style="border-collapse:collapse;" width="100%">
      ...
      <tbody>
        ...
        $query = mysqli_query($koneksi, "SELECT  masuk.kode_brg, nama_brg, masuk.jumlah, masuk.satuan, masuk.unit, tgl_masuk FROM masuk INNER JOIN stokbarang ON masuk.kode_brg = stokbarang.kode_brg  WHERE tgl_masuk='$tgl' "); 
