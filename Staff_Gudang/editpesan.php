                ...
                <form method="post"  action="edit_proses.php" class="form-horizontal">
                    <div class="box-body">
                        ...
                        <div class="form-group">
                         ...
                         <div class="form-group">
                            <label for="Tujuan" class="col-sm-offset-1 col-sm-3 control-label">Jumlah</label>
                            <div class="col-sm-2">
                                <input type="text" value="<?= $row2['tujuan'] ?>"class="form-control" name="tujuan">
                            </div>
                        </div>

                         <div class="form-group">
                            <label for="nama_karyawan" class="col-sm-offset-1 col-sm-3 control-label">Nama Karyawan</label>
                            <div class="col-sm-2">
                                <input type="text" value="<?= $row2['nama_karyawan'] ?>"class="form-control" name="nama_karyawan">
                            </div>
                        </div>
