    ...
    <div class="col-sm-12 col-xs-18">
      <div class="box box-primary">
        <div class="box-header with-border">
          <h3 class="text-center">Detil Laporan Pemeliharaan Barang</h3>
        </div>
        ...
        <div class="box box-info">
          <div class="box-header with-border">
            <div class="form-group">
              ...
              <div class="col-md-12">
                <form method="POST" action='cetak_laporan_detil_pemeliharaan.php' target="_blank" class="form-inline">
                  <div class="form-group">
                    <label> Periode</label>
            ...
            <tbody>   
              ...
              if (mysqli_num_rows($query))      {
               ...
               <?php  endwhile; } else { 
                ...
                window.location='index.php?p=detil_lap_pemeliharaan'</script>
                ";}
