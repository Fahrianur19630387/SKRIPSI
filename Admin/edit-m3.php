            ...
            <div class="row">
                <div class="col-sm-8 col-sm-offset-2 col-xs-12">
                    <div class="box box-primary">
                        ...
                        <form method="post"  action="edit-proses-m3.php" class="form-horizontal"enctype="multipart/form-data">
                            ...
                            <div class="col-sm-4">
                                ...
                                <option value="">--Pilih Level--</option>
                                    ...
                                    <option  <?php if($row2['category'] == "VACC_VACCINE") echo "selected"; ?>  value="VACC_VACCINE">VACC_VACCINE</option>
                                    <option  <?php if($row2['category'] == "MED_MEDICINE") echo "selected"; ?> value="MED_MEDICINE">MED_MEDICINE</option>
                                    <option  <?php if($row2['category'] == "DISF_DISINFECTANT") echo "selected"; ?> value="DISF_DISINFECTANT">DISF_DISINFECTANT</option>
                                ...
                                <div class="form-group">
                                    <label for="stok" class="col-sm-offset-1 col-sm-3 control-label">Jumlah</label>
                                    <div class="col-sm-4">
                                        <input type="number" class="form-control" value="<?= $row2['stok']; ?>" name="stok">
                                    </div>
                                </div>
                            ...
                            <div class="col-sm-4">
                                ...
                                <div class="form-group">
                                    ...
                                    <a href="index.php?p=material-m3&id_jenis=3" style="margin:10px;" class="btn btn-success"><i class='fa fa-backward'>  Kembali</i></a>                                                                             
                                </div>
                            </div>
                        </form>
                    </div>
