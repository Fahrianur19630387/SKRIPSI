        ...
        <div class="col-sm-12 col-xs-12">
            <div class="box box-primary">
                <div class="box-header with-border">
                    <h3 class="text-center">Tambah Data Stok Ayam</h3>
                </div>
                <form method="post"  action="add-proses-m5.php" class="form-horizontal" enctype="multipart/form-data">
                    <div class="box-body">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-4">
                                <select id="jenis_brg" required="isikan dulu" class="form-control" name="id_jenis">
                                    ...
                                    $queryJenis = mysqli_query($koneksi, "select * from jenis_barang WHERE id_jenis=5");
                            ...
                            <div class="form-group">
                                ...
                                <a href="index.php?p=material-m5&id_jenis=5" style="margin:10px;" class="btn btn-success"><i class='fa fa-backward'>  Kembali</i></a>  
