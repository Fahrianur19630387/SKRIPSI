...
//script validasi data
	...
	if ($cek > 0){
		...
		window.location='index.php?p=formpengajuan'</script>";
	}else {
		$query = "INSERT into pengajuan_sementara (unit, kode_brg, id_jenis,  jumlah, satuan, category,  tgl_pengajuan) VALUES 
		('$unit', '$kode_brg', '$id_jenis', '$jumlah', '$satuan', '$category', '$tgl_pengajuan')
