...
$unit = $_GET['unit'];
$Staff_Gudang = $_GET['Staff_Gudang'];
$tgl= $_GET['tgl'];
...
<table>
	...
	<div class="isi" style="margin: 0 auto;">
		<p style="color: black; text-align: left;">Pengeluaran Permintaan Barang dari Staff_Gudang : <?= $Staff_Gudang; ?><br>Pada tanggal : <b> <?=  tanggal_indo($tgl); ?></b></p>
		<table class="tabel2">
			<thead>
				<tr>
