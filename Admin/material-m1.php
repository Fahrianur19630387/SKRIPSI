    ...
    <div class="col-sm-12">
      <div class="box box-primary">
        <div class="box-header with-border">
          <h3 class="text-center">DATA STOCK BARANG</h3>
        </div>                
        <div class="box-body">
          <div class="row">
            <div class="col-md-2">
              <a href="index.php?p=tambahmaterial-m1" class=" btn btn-primary"><i class="fa fa-plus"></i> Tambah Data Material</a><br>						
            </div>

            <div class="col-md-2 pull-right">
              <a target="_blank" href="cetak_material.php?" class="btn btn-success"><i class="fa fa-print"></i> Cetak Data Material</a><br>
            </div>
            <br><br>
          </div>                        
            ...
            <tr>
             ...
             if (mysqli_num_rows($query)) {
               while($row=mysqli_fetch_assoc($query)):
                ...
                <td>
                  <a href="?p=edit-m1&aksi=edit-m1&id=<?= $row['kode_brg']; ?>"><span data-placement='top' data-toggle='tooltip' title='Update'><button  class="btn btn-info">Update</button></span></a>                     
