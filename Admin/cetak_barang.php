...
<html> 
<head> 
<title>Laporan Data Barang Berdasarkan id_jenis</title>
...
<?php 
 ...
 include "../fungsi/koneksi.php";
  ...
  $query = "SELECT * FROM user WHERE user.level ='Manager' ";
    $hasil = mysqli_query($koneksi,$query);
  $query2 = "SELECT * FROM user WHERE user.level ='Admin' ";
...
?>
  ...
  <tr>
    ...
    <td align="left"><b><h4><u><?php echo $data2['username']; ?></u></h4></b></td>
    <td><b></b></td>
  ...
  <tr>
    <td align="left"><b><h4><?php echo $data2['jabatan']; ?></h4></b></td>
    <td><b></b></td>
    <td width="600px" align="left"><b></b></td>
