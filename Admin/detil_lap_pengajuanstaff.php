    ...
    <div class="col-sm-12 col-xs-18">
      <div class="box box-primary">
        <div class="box-header with-border">
          <h3 class="text-center">Detil Laporan Pengajuan Barang</h3>
        </div>
        ...
        <div class="box box-info">
          <div class="box-header with-border">
            <div class="form-group">
              ...
              <div class="col-md-12">
                <form method="POST" action='cetak_lap_detilpengajuanstaff.php' target="_blank" class="form-inline">
                  <div class="form-group">
                    <label> Periode</label>
          ...
          <table class="table table-responsive">
            ...
            <tbody>   
              ...
              <?php
               $query = mysqli_query($koneksi, "SELECT  pengajuan.kode_brg, nama_brg, pengajuan.satuan, pengajuan.unit, pengajuan.jumlah, pengajuan.category, tgl_pengajuan FROM pengajuan INNER JOIN stokbarang ON pengajuan.kode_brg = stokbarang.kode_brg  WHERE unit='$unit' AND tgl_pengajuan BETWEEN '$tanggala' and '$tanggalb' "); 
              ...
              if (mysqli_num_rows($query))      {
               ...
               <?php  endwhile; } else { 
                ...
                window.location='index.php?p=detil_lap_pengajuanstaff'</script>
                ";}
