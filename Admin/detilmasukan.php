...
if (isset($_GET['tgl']) && isset($_GET['unit'])) {
    ...
    $query = mysqli_query($koneksi, "SELECT masuk.tgl_masuk, masuk.id_masuk, masuk.kode_brg, masuk.jumlah, masuk.status, stokbarang.nama_brg, stokbarang.satuan FROM masuk INNER JOIN 
    ...
    <div class="row">
        <div class="col-sm-12">
         <div class="box box-primary">
            ...
            <div class="box-body">                   
                <a href="index.php?p=databarangmasuk" style="margin:10px;" class="btn btn-success"><i class='fa fa-backward'>  Kembali</i></a>
