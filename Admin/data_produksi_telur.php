<?php  
      ...
      if (isset($_GET['aksi']) && isset($_GET['id'])) {
        ...
        if ($_GET['aksi'] == 'edit') {
            header("location:?p=edit_produksi_telur&id=$id");
        } else if ($_GET['aksi'] == 'hapus') {
            header("location:?p=hapus_produksi_telur&id=$id");
        } 
    }
                					...
                					<?php 
                					 ...
                					 ?>
                                        ...
                                        <td><?= $row['komersil']; ?> </td>
                                         ...
                                         <td>
                                            <a href="?p=edit_produksi_telur&aksi=edit&id=<?= $row['kode']; ?>"><span data-placement='top' data-toggle='tooltip' title='Edit'><button  class="btn btn-info">Edit</button></span></a>                     

                                            <a href="?p=hapus_produksi_telur&aksi=hapus&id=<?= $row['kode']; ?>"><span data-placement='top' data-toggle='tooltip' title='Hapus'><button  class="btn btn-danger" onclick="return confirm('Yakin ingin menghapus?')">Hapus</button></span></a>                    
                                        </td>              					
                				</tr>
                			<?php $no++; endwhile; } ?>
                			</tbody>
