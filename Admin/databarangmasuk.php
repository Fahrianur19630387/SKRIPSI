...
$query = mysqli_query($koneksi, "SELECT unit, tgl_pengajuan, kode_brg  FROM pengajuan WHERE unit= '$_SESSION[username]'  GROUP BY tgl_pengajuan  ");    
     ...
     <div class="box box-primary">
      ...
      <div class="box-body">
        ...
        <div class="table-responsive">
          <table class="table text-center" id="barangmasuk">
            <thead  > 
              <tr>
                <th>No</th>                                                                                             
              ...
              <tr>
                ...
                if (mysqli_num_rows($query)) {
                  while($row=mysqli_fetch_assoc($query)):
                   ...
                   <td>
                    <a href="?p=detilmasukan&unit=<?= $row['unit'];?>&tgl=<?= $row['tgl_pengajuan']; ?>"><span data-placement='top' data-toggle='tooltip' title='Input Barang Masuk'>
