        ...
        <div class="box-body">
          <div class="row">
            ...
            <div class="col-md-2 pull-right">
              <a target="_blank" href="cetak_pakan.php?" class="btn btn-success"><i class="fa fa-print"></i> Cetak Data Pakan</a><br>
            </div>
            <br><br>
          </div>                        
            ...
            <tr>
             ...
             if (mysqli_num_rows($query)) {
               while($row=mysqli_fetch_assoc($query)):
                ...
                <td>
                  <a href="?p=edit-m4&aksi=edit&id=<?= $row['kode_brg']; ?>"><span data-placement='top' data-toggle='tooltip' title='Update'><button  class="btn btn-info">Update</button></span></a>                     

                  <a href="?p=material-m4&aksi=hapus&id=<?= $row['kode_brg']; ?>"><span data-placement='top' data-toggle='tooltip' title='Hapus'><button  class="btn btn-danger" onclick="return confirm('Yakin ingin menghapus ?')">Hapus</button></span></a>                    
                </td>              					
              </tr>
              <?php $no++; endwhile; } ?>
            </tbody>
