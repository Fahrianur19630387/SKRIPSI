...
<head>
  ...
  <title>Aplikasi Monitoring Inventory CPJF Banjarmasin 1</title>
  <link rel="shortcut icon" type="image/icon" href="../cpf.jpg">
  ...
  <section class="sidebar">      
    <ul class="sidebar-menu">
      ...
      <li class="treeview">
        ...
        <ul class="treeview-menu">
         <li><a href="index.php?p=data_produksi_telur" ><i class="fa fa-circle-o"></i>Data Produksi</a></li>
     ...
     <li class="treeview">
      ...
      <ul class="treeview-menu">
        <li><a href="index.php?p=datapermintaan" ><i class="fa fa-circle-o"></i>Permintaan</a></li>
      </ul>
      <ul class="treeview-menu">
        <li><a href="index.php?p=datapengeluaran" ><i class="fa fa-circle-o"></i>Data Permintaan</a></li>
      </ul>
    </li> 
    <li class="treeview">
      <a href="#">
      ...
      <ul class="treeview-menu">
        <li><a href="index.php?p=formpengajuan" ><i class="fa fa-circle-o"></i>Pengajuan</a></li>
        <li><a href="index.php?p=datapengajuan" ><i class="fa fa-circle-o"></i>Data Pengajuan</a></li>
          ...
          <li class="">
      <a href="index.php?p=data_pemeliharaan">
