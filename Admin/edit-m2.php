            ...
            <div class="row">
                <div class="col-sm-8 col-sm-offset-2 col-xs-12">
                    <div class="box box-primary">
                        ...
                        <form method="post"  action="edit-proses-m2.php" class="form-horizontal" enctype="multipart/form-data">
                            ...
                            <div class="col-sm-4">
                                ...
                                <div class="form-group">
                                    ...
                                    <a href="index.php?p=material-m2&id_jenis=2" style="margin:10px;" class="btn btn-success"><i class='fa fa-backward'>  Kembali</i></a>                                                                
                                </div>
                            </div>
                        </form>
                    </div>
