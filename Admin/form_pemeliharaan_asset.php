        ...
        <div class="col-sm-6 col-xs-18">
            <div class="box box-primary">
                <div class="box-header with-border">
                    <h3 class="text-center">Form Pengajuan Service Asset</h3>
                </div>
                <form method="post" id="tes"  action="simpan_pengajuansementara.php" class="form-horizontal">
                    <div class="box-body">
                        ...
                        <div class="form-group">
                            ...
                            <div class="form-group">
                                <label for="stok" class=" col-sm-3 control-label">Catatan</label>
                                <div class="col-sm-2">
                ...
                <div class="box box-info">
                    ...
                    <table class="table table-responsive">
                        ...
                        <tr>
                            <?php 
                            $sekarang  = date("Y-m-d");
                            $queryTampil = mysqli_query($koneksi, "SELECT pemeliharaan.jumlah ,  pemeliharaan.id_pemeliharaan, stokbarang.nama_brg FROM pemeliharaan INNER JOIN stokbarang ON pemeliharaan.kode_brg  = stokbarang.kode_brg WHERE tanggal = '$sekarang' AND pemeliharaan.unit='$_SESSION[username]' "  );
                            $no = 1;
                            if(mysqli_num_rows($queryTampil) > 0) {
                                while($row = mysqli_fetch_assoc($queryTampil)):
                                   ...
                                   <td><a href="hapus_pengajuansementara.php?id=<?php echo $row['id_pemeliharaan']; ?>" class="btn btn-danger">Hapus</a></td>
                               </tr>
                          ...
                          <div class="box-body">   
                            <a class="btn btn-success" href="pesanpengajuan.php" >Buat Pengajuan</a>
