...
<body>  
  ...
  <div class="isi" style="margin: 0 auto;">
    ...
    <table class="tabelatas">
      ...
      <tr>
        <td style="text-align: left; width=80px;  "><b>Staff_Gudang </b></td>   
    ...
    <br>
     ...
     <tbody>
      ...
      $query = mysqli_query($koneksi, "SELECT  pengajuan.kode_brg, nama_brg, pengajuan.satuan, pengajuan.jumlah, pengajuan.unit, pengajuan.category, tgl_pengajuan FROM pengajuan INNER JOIN stokbarang ON pengajuan.kode_brg = stokbarang.kode_brg  WHERE unit='$unit' AND tgl_pengajuan BETWEEN '$tanggala' and '$tanggalb' "); 
      $i   = 1;
...

      {
        ...
        <tr>
          ...
          <td style="text-align: center; font-size: 12px;"><?php echo $data['tgl_pengajuan']; ?></td>
...
?>
  ...
  <tr>
    <td align="left"><b><h4>Pimpinan</h4></b></td>
    <td><b></b></td>
    <td width="600px" align="left"><b></b></td>
