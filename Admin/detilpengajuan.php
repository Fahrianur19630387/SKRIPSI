...
if (isset($_GET['tgl']) && isset($_GET['unit'])) {
    ...
    $query = mysqli_query($koneksi, "SELECT pengajuan.tgl_pengajuan, pengajuan.id_pengajuan, pengajuan.kode_brg, pengajuan.jumlah, pengajuan.category, pengajuan.status, stokbarang.nama_brg, stokbarang.satuan, stokbarang.category FROM pengajuan INNER JOIN 
