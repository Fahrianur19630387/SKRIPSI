        ...
        <div class="col-sm-12 col-xs-12">
            <div class="box box-primary">
                <div class="box-header with-border">
                    <h3 class="text-center">Tambah Data Stok VMD</h3>
                </div>
                <form method="post"  action="add-proses-m3.php" class="form-horizontal" enctype="multipart/form-data">
                    <div class="box-body">
                        ...
                        <div class="form-group">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-4">
                                    <select id="category" required="isikan dulu" class="form-control" name="category">
                                    <option value="">--Pilih Category--</option>
                                    <option value="VACC_VACCINE">VACC_VACCINE</option>
                                    <option value="MED_MEDICINE">MED_MEDICINE</option>
                                    <option value="DISF_DISINFECTANT">DISF_DISINFECTANT</option>
                                    </select>
                                </div>
                            </div>
                            <div class="form-group">
