...
$cek = mysqli_num_rows(mysqli_query($koneksi,"SELECT * FROM stokbarang WHERE kode_brg='$kode_brg'"));
  if ($cek > 0){
    ...
    window.location='index.php?p=tambahmaterial-m2'</script>";
  }else {
$query = "INSERT into stokbarang (kode_brg, id_jenis, nama_brg, category, satuan, gambar) VALUES 
	...
	if ($hasil) {
		echo '<script language="javascript">alert("Data Berhasil Disimpan !!!"); document.location="index.php?p=material-m2&id_jenis=2";</script>';
	} else {
