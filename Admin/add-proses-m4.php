...
$cek = mysqli_num_rows(mysqli_query($koneksi,"SELECT * FROM stokbarang WHERE kode_brg='$kode_brg'"));
  if ($cek > 0){
    ...
    window.location='index.php?p=tambahmaterial-m4'</script>";
  }else {
	...
	if ($hasil) {
		echo '<script language="javascript">alert("Data Berhasil Disimpan !!!"); document.location="index.php?p=material-m4&id_jenis=4";</script>';
	} else {
