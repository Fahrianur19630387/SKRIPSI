...
--
-- Host: 127.0.0.1
-- Waktu pembuatan: 06 Agu 2023 pada 15.50
...
INSERT INTO `permintaan` (`id_permintaan`, `unit`, `Staff_Gudang`, `kode_brg`, `id_jenis`, `jumlah`, `tgl_permintaan`, `tujuan`, `status`) VALUES
...
INSERT INTO `sementara` (`id_sementara`, `unit`, `kode_brg`, `id_jenis`, `jumlah`, `tgl_permintaan`, `tujuan`, `status`) VALUES
(122, 'melia', 'VL15810', 3, 1, '2023-08-06', '', 0);
...
(78, '110.01.0776', 1, 'BANDO VAN BELT A-89', 'G11_ME PARTS & POND MATERIALS', 'PC', 10, 1, 5, '64ca61d69b044.jpeg'),
...
--
ALTER TABLE `permintaan`
  MODIFY `id_permintaan` int(100) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=119;

--
-- AUTO_INCREMENT untuk tabel `sementara`
--
ALTER TABLE `sementara`
  MODIFY `id_sementara` int(100) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=123;
