...
<head>
  ...
  <title>Aplikasi Monitoring Data Aset Inventory CPJF Banjarmasin 1</title>
      ...
      <li class="treeview">
        ...
        <ul class="treeview-menu">
         ...
         <li><a href="index.php?p=material-m5&id_jenis=5" ><i class="fa fa-circle-o"></i>AYAM</a></li>
          ...
          <li><a href="index.php?p=datapengeluaran" ><i class="fa fa-files-o"></i>Data Permintaan Barang</a></li>
      
       

              <li><a href="index.php?p=data_permintaan_pemeliharaan_barang" ><i class="fa fa-files-o"></i>Data Pemeliharaan Barang</a></li>
