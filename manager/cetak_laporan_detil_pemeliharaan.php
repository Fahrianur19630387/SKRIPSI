...
<body>  
       ...
       <div class="judul">
        ...
        <hr class="garis">
         <H4><b>BUKTI PERMINTAAN PEMELIHARAAN BARANG (BPPP)</b></H4>
  <hr>
  ...
  <div class="isi" style="margin: 0 auto;">
    ...
    <table border="1" align="center" style="border-collapse:collapse;" width="100%">
      ...
      <tbody>
       ...
       $query = mysqli_query($koneksi, "SELECT * FROM pemeliharaan WHERE unit='$unit' AND tgl_pemeliharaan BETWEEN '$tanggala' and '$tanggalb' "); 
        $i   = 1;
        $total = 0;
