                    ...
                    <div class="box-body">
                        ...
                        <div class="form-group">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-4">
                                    <input id="satuan" disabled value="----" type="text" class="form-control" name="satuan">
                                </div>
                            </div>
                            <div class="form-group">
                                <label for="category" class="col-sm-3 control-label">Category</label>
                                <div class="col-sm-2">
                                    <input id="category"  disabled value="----" type="text" class="form-control"  name="category">
                                </div>                                          
                            </div>
                    ...
                    <table class="table table-responsive">
                        ...
                        <tr>
                            ...
                            if(mysqli_num_rows($queryTampil) > 0) {
                               ...
                               <tr>
                                  <?php
                                  $query = mysqli_query($koneksi, "SELECT jumlah  FROM pengajuan_sementara   ");  
