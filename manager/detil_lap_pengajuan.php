        ...
        <div class="box box-info">
          ...
          <table class="table table-responsive">
            ...
            <tbody>   
              ...
              $query = mysqli_query($koneksi, "SELECT  pengajuan.kode_brg, nama_brg, pengajuan.satuan, pengajuan.jumlah, pengajuan.category, tgl_pengajuan FROM pengajuan INNER JOIN stokbarang ON pengajuan.kode_brg = stokbarang.kode_brg  WHERE unit='$unit' AND tgl_pengajuan BETWEEN '$tanggala' and '$tanggalb' "); 
